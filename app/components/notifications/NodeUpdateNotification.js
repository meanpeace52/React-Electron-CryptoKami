...
const messages = defineMessages({
  acceptLabel: {
    ...
    description: 'Label "Update and restart" on the KAMI node update notification.'
  },
  denyLabel: {
    id: 'cardano.node.update.notification.postpone.button.label',
    defaultMessage: '!!!Postpone until restart',
    description: 'Label "Postpone until restart" on the KAMI node update notification.'
  },
  titleWithVersion: {
    id: 'cardano.node.update.notification.titleWithVersion',
    defaultMessage: '!!!KAMI-Core update v{version} is available',
    description: 'KAMI-Core update notification with version.'
  },
  titleWithoutVersion: {
    id: 'cardano.node.update.notification.titleWithoutVersion',
    defaultMessage: '!!!KAMI-Core update is available',
    description: 'KAMI-Core update notification without version.'
  },
  updateMessage: {
    id: 'cardano.node.update.notification.message',
    defaultMessage: '!!!KAMI Wallet and KAMI node update is available. Would you like to install the update?',
    description: 'Message shown when there is a KAMI Wallet and KAMI node update available.'
  },
});
