...
const messages = defineMessages({
  regularTabTitle: {
    ...
    description: 'Tab title "Regular" on KAMI redemption page.'
  },
  forceVendedTabTitle: {
    id: 'wallet.redeem.choices.tab.title.forceVended',
    defaultMessage: '!!!Force vended',
    description: 'Tab title "Force vended" on KAMI redemption page.'
  },
  paperVendedTabTitle: {
    id: 'wallet.redeem.choices.tab.title.paperVended',
    defaultMessage: '!!!Paper vended',
    description: 'Tab title "Paper vended" on KAMI redemption page.'
  },
});
