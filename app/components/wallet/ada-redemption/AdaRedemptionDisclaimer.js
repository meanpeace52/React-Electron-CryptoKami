...
const messages = defineMessages({
  disclaimerTitle: {
    ...
    defaultMessage: '!!!KAMI Wallet Redemption Disclamer',
    description: 'Title of "Redemption disclaimer" on KAMI redemption page.'
  },
  disclaimerText: {
    id: 'wallet.redeem.disclaimerOverlay.disclaimerText',
    defaultMessage: '!!!ATTENTION: Redeeming on the KAMI Test-net will validate that your certificate or redemption key is correct and will allow you to redeem TEST-KAMI for testing purposes only. KEEP your certificate or redemption key safe and secure. You will need to redeem again when KAMI launches the mainnet. TEST-KAMI holds no value and cannot be exchanged.',
    description: 'Disclaimer text for "Redemption disclaimer" on KAMI redemption page.'
  },
  checkboxLabel: {
    id: 'wallet.redeem.disclaimerOverlay.checkboxLabel',
    defaultMessage: '!!!I’ve understood the information above',
    description: 'Label for "I’ve understood the information above" checkbox on KAMI redemption page "Redemption disclaimer".'
  },
  submitLabel: {
    id: 'wallet.redeem.disclaimerOverlay.submitLabel',
    defaultMessage: '!!!Continue',
    description: 'Label for "Continue" button on KAMI redemption page "Redemption disclaimer".'
  },
});
