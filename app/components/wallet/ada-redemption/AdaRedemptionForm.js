...
const messages = defineMessages({
  headline: {
    ...
    defaultMessage: '!!!KAMI Redemption',
    description: 'Headline "KAMI redemption" dialog.'
  },
  instructionsRegular: {
    id: 'wallet.redeem.dialog.instructions.regular',
    defaultMessage: `!!!<p>To redeem your KAMI, upload your certificate or copy and paste your redemption code from the certificate.
...
passphrase</strong> to decrypt your certificate and your redemption code will be automatically extracted.</p>`,
    description: 'Detailed instructions for redeeming KAMI from the regular vending',
  },
...
<p>If you upload an <strong>encrypted certificate</strong>, you will need to provide <strong>your email address, KAMI passcode and KAMI amount</strong>
to decrypt your certificate and your redemption code will be automatically extracted.</p>`,
    description: 'Detailed instructions for redeeming KAMI from the force vending',
  },
  instructionsPaperVended: {
    id: 'wallet.redeem.dialog.instructions.paperVended',
    defaultMessage: `!!!<p>To redeem your KAMI, enter your shielded vending key from the certificate, choose a wallet
where KAMI should be redeemed and enter 9 word mnemonic passphrase.</p>`,
    description: 'Detailed instructions for redeeming KAMI from the paper vending',
  },
  certificateLabel: {
  ...
  walletSelectLabel: {
    ...
    description: 'Label for the wallet select field on KAMI redemption form'
  },
  passphraseLabel: {
    id: 'wallet.redeem.dialog.passphraseLabel',
    defaultMessage: '!!!Passphrase to Decrypt the KAMI Voucher Certificate',
    description: 'Label for the passphrase to decrypt KAMI voucher certificate input'
  },
  passphraseHint: {
  ...
  redemptionKeyLabel: {
    ...
    description: 'Label for KAMI redemption key input',
  },
  ...
  submitLabel: {
    ...
    description: 'Label for the "KAMI redemption" dialog submit button.'
  },
  emailLabel: {
  ...
  adaPasscodeLabel: {
    ...
    defaultMessage: '!!!KAMI passcode',
    description: 'Label for the KAMI passcode input field.'
  },
  adaPasscodeHint: {
    id: 'wallet.redeem.dialog.adaPasscodeHint',
    defaultMessage: '!!!Enter your KAMI passcode',
    description: 'Hint for the KAMI passcode input field.'
  },
  adaAmountLabel: {
    id: 'wallet.redeem.dialog.adaAmountLabel',
    defaultMessage: '!!!KAMI amount',
    description: 'Label for the KAMI amount input field.'
  },
  adaAmountHint: {
    id: 'wallet.redeem.dialog.adaAmountHint',
    defaultMessage: '!!!Enter your KAMI amount',
    description: 'Hint for the KAMI amount input field.'
  },
