...
const messages = defineMessages({
  ...
  overlayText: {
    ...
    defaultMessage: '!!!Attention, KAMI Wallet is unable to sync with the blockchain because the time on your machine is different from the global time. You are 2 hours 12 minutes 54 seconds behind.<br>To synchronize the time and fix this issue, please visit the FAQ section of KAMI Wallet website:',
    description: 'Text of Sync error overlay'
  },
  problemSolutionLink: {
    id: 'systemTime.error.problemSolutionLink',
    defaultMessage: '!!!KAMIwallet.io/faq',
    description: 'Link to KAMI Wallet website FAQ page'
  },
});
