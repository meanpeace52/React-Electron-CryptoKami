...
const messages = defineMessages({
  ...
  alternativeInstructionsStep2: {
    ...
    defaultMessage: '!!!Click the Submit manually button, which will take you to the issue-reporting page on the KAMI Wallet website.',
  ...
  submitManuallyLink: {
    ...
    defaultMessage: '!!!KAMIwallet.io/problem',
    description: 'Link to KAMI Wallet website "Problem" page'
  },
  downloadButtonLabel: {
