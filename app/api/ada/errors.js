...
const messages = defineMessages({
  ...
  redeemAdaError: {
    ...
    defaultMessage: '!!!Your KAMI could not be redeemed correctly.',
    description: '"Your KAMI could not be redeemed correctly." error message.'
  },
  ...
  notAllowedToSendMoneyToRedeemAddressError: {
    ...
    defaultMessage: '!!!It is not allowed to send money to KAMI redemption address.',
    description: '"It is not allowed to send money to KAMI redemption address." error message.'
  },
  ...
  notEnoughFundsForTransactionFeesError: {
    ...
    defaultMessage: '!!!Not enough KAMI for fees. Try sending a smaller amount.',
    description: '"Not enough KAMI for fees. Try sending a smaller amount." error message'
  },
});
