...
THIS TERMS OF SERVICE AGREEMENT (&quot;Agreement&quot;) is made between Input Output HK Limited (&quot;Company&quot;) and any person (&quot;User&quot;) who completes the process to download, utilize, or operate any software, data processing service, application, communication service, or other content created or offered by Company, including, but not limited to, the KAMI Cryptocurrency Wallet application (&quot;Software&quot;). Company and User are collectively referred to as the &quot;parties.&quot;
...
User acknowledges and agrees that by redeeming KAMI in the testnet User redeems test-KAMI only, and that in order to redeem actual KAMI, User must repeat the procedure in the mainnet, once released.
