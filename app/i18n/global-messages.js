...
export default defineMessages({
  ...
  invalidAdaRedemptionCertificate: {
    ...
    defaultMessage: '!!!The KAMI redemption code could not be parsed from the given document.',
    description: 'Error message shown when invalid KAMI redemption certificate was uploaded.',
  },
  invalidAdaRedemptionEncryptedCertificate: {
    id: 'global.errors.AdaRedemptionEncryptedCertificateParseError',
    defaultMessage: '!!!The KAMI redemption code could not be parsed, please check your passphrase.',
    description: 'Error message shown when invalid KAMI redemption encrypted certificate was uploaded.',
  },
  invalidWalletName: {
  ...
  unitAda: {
    id: 'global.unit.ada',
    defaultMessage: '!!!KAMI',
    description: 'Name for "KAMI" unit.'
  },
  unitEtc: {
    id: 'global.unit.etc',
    defaultMessage: '!!!Etc',
...
export const environmentSpecificMessages = {
  ada: defineMessages({
    ...
    apiName: {
      ...
      defaultMessage: '!!!KAMI',
      description: 'Name for "KAMI" client.'
    },
    apiVersion: {
      id: 'environment.apiVersion.cardano',
      defaultMessage: '!!!1.0.4',
      description: 'Version of "KAMI" client.'
    },
  }),
  etc: defineMessages({
    currency: {
